...
Creation of two models ($$\theta_{1}.$$ and $$\theta_{2}.$$) capable of predicting whether the ferrite phase fraction is in the range 1: $$F_f \in  [0.7; 0.8]$$ and is within the range 2: $$F_f \in [0.7; 0.85]$$.
